...
🌟 **Настройки управления в игре:** - передвижение с помощью стрелочек или мыши(рекомендуется стрелочки), бег на Shift, открытие меню на Esc, взаимодействие с объектами на Enter.
